...
uint8_t walk_position = 0;

void walk_Draw(void)
{
    // a box behind the character
    dog_SetBox(30,22,36,41);
    dog_ClrBox(31,23,35,40);

    // draw the character
    dog_SetBitmapP(walk_position,30,bitmaps+walk_cycle*24, 10, 12);

    // a box before the character
    dog_SetBox(40,12,46,31);
    dog_ClrBox(41,13,45,30);

    // draw the cartoon frame
    dog_ClrBox(0,0,15,DOG_HEIGHT-1);
    dog_ClrBox(DOG_WIDTH-15,0,DOG_WIDTH-1,DOG_HEIGHT-1);
    dog_SetVLine(15,0,50);
    dog_SetVLine(DOG_WIDTH-15,0,50);
    dog_SetHLine(0,DOG_WIDTH-1, 5);  
}
